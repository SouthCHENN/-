...
(function () {
  ...
  var CSS = [
    ...
    /* 浅色模式按钮底色取周围页面实际底色（#E2E7F6），与深色模式太阳按钮
       融入背景的表现保持一致 */
    'html.zz-light .zz-fab{background:rgba(226,231,246,.92);box-shadow:0 2px 10px rgba(20,40,60,.14);color:#33566E;border-color:rgba(51,86,110,.45)}',
